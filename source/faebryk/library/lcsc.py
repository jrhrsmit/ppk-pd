# TODO should be part of faebryk, copied from cabletester, see:
# https://github.com/IoannisP-ITENG/CableTester/blob/master/source/faebryk/library/lcsc.py
...
def attach_footprint(component: Component, partno: str, get_model: bool = True):
    ...
    out_base_path = Path(__file__).parent.joinpath("../../libs")
